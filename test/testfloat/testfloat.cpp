...
constexpr TypedValue from_bits(ValType ty, uint64_t bits) noexcept
{
    ...
    {
    case ValType::i32:
    case ValType::f32:  // For f32 interpret bits as FP value not to convert sNaN -> qNaN.
        return {ty, Value{static_cast<uint32_t>(bits)}};
    case ValType::i64:
    case ValType::f64:  // For f64 interpret bits as FP value not to convert sNaN -> qNaN.
        return {ty, bits};
    }
